    ...
    <div className="product">
      ...
      <main className="workspace">
        ...
        <section className="content-grid">
          ...
          <div className="card video-card"><div><p className="eyebrow">Featured training</p><h2>Ask ChatGPT These 4 Questions</h2><p>Use this embedded session alongside your weekly review to turn AI prompts into concrete income-focused habits.</p></div><div className="video-frame"><iframe width="1032" height="581" src="https://www.youtube.com/embed/DC_tGz_GPtg" title="Ask ChatGPT These 4 Questions, It Will Change Your Bank Account" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe></div></div>
        </section>
